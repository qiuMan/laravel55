            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('loginPwd') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Password</label>

                            <div class="col-md-6">
                                <input id="loginPwd" type="password" class="form-control" name="loginPwd" required>

                                @if ($errors->has('loginPwd'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('loginPwd') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
